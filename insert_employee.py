...
class Ui_insert_employee(object):
    ...
    def retranslateUi(self, insert_employee):
        ...
        self.pushButton.setText(_translate("insert_employee", "Submit"))
        self.pushButton_2.setText(_translate("insert_employee", "Clear"))
        self.pushButton_3.setText(_translate("insert_employee", "Exit"))
        self.label_4.setText(_translate("insert_employee", "Age"))
        self.label_6.setText(_translate("insert_employee", "Salary"))
        self.label.setText(_translate("insert_employee", "Employee ID"))
        self.label_3.setText(_translate("insert_employee", "Sex"))
        self.label_5.setText(_translate("insert_employee", "Tel"))
        self.label_2.setText(_translate("insert_employee", "Name"))
        self.radioButton.setText(_translate("insert_employee", "man"))
        self.radioButton_2.setText(_translate("insert_employee", "women"))
    ...
    def insertEmployee(self):
        ...
        if self.sex is None:
            ...
            if changed_row == original_row+1:
                self.statusbar.showMessage("Add Success", 2000)
            else:
                self.statusbar.showMessage("Add Failed",2000)
