...
class Ui_delbook(object):
    ...
    def retranslateUi(self, delbook):
        ...
        delbook.setWindowTitle(_translate("delbook", "Delete Book"))
        self.pushButton_2.setText(_translate("delbook", "Submit"))
        self.pushButton_3.setText(_translate("delbook", "Exit"))
        self.label.setText(_translate("delbook", "ISBN"))
        self.pushButton.setText(_translate("delbook", "Clear"))
